...
const meta = {
  title: "Auth/Forms/PhoneLoginForm",
...
/**
 * Default phone login form
 * Shows the basic form structure with phone number, password, and terms checkbox
 */
 ...
 * should be tested in phone-login.test.tsx using RTL
 */
