...
<!--
首先进入第一部分，演示环节。我们将通过一段视频来展示 Nomad 机票预订系统的核心业务功能。
-->
...
> 这段视频由 apps/demo 应用生成，展示了从用户注册到支付完成的完整业务闭环

</v-click>

<!--
[click] 这段视频展示了完整的业务流程。首先是用户注册环节，支持手机号和邮箱两种注册方式。

[click] 然后是航班搜索，用户可以选择单程或往返，选择座舱等级，输入出发地和目的地。

[click] 接下来是订单创建，用户填写乘客信息和联系人信息，选择增值服务。

[click] 最后是支付完成，订单确认并进入订单管理系统。

[click] 这段视频是由 apps/demo 应用自动生成的，它基于 Remotion 框架，将我们的业务流程可视化，帮助团队成员和外部协作者快速理解系统功能。
-->
