import{j as e}from"./iframe-BTcpGzrz.js";import{u as f,a as v,F as w,b as l,c as p,d as u,e as h,f as x}from"./form-B2Th5BYx.js";import{L as b}from"./link-DH4CXJC0.js";import{B as j}from"./button-DHKYmhBo.js";import{C as F}from"./checkbox-B1FMXtJ6.js";import{I as y}from"./input-ihr4IGkN.js";import{d as N}from"./auth-D-RBnuxz.js";import"./preload-helper-PPVm8Dsz.js";import"./schemas-Kzq7Ayg9.js";import"./index-CS2SUhPe.js";import"./label-Ccw3dncI.js";import"./index-kspR1Gx8.js";import"./index-Di5ObQFr.js";import"./utils-CBfrqCZ4.js";import"./use-merged-ref-CngfgJua.js";import"./index-CdJFUDDL.js";import"./index-CQpUqVhg.js";import"./index-DljmLQtd.js";import"./index-CGYOYVqM.js";import"./index-C4i06nyu.js";import"./check-Dj0asSqx.js";import"./createLucideIcon-Cg9RxXW5.js";function m({onSubmit:s,isLoading:n=!1}){const o=f({resolver:v(N),defaultValues:{phoneNumber:"",password:"",agreedToTerms:!1}}),d=t=>{s(t)};return e.jsx(w,{...o,children:e.jsxs("form",{onSubmit:o.handleSubmit(d),className:"space-y-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx(l,{control:o.control,name:"phoneNumber",render:({field:t})=>e.jsxs(p,{children:[e.jsx(u,{className:"text-sm font-medium text-gray-700",children:"手机号"}),e.jsx(h,{children:e.jsx(y,{...t,type:"tel",placeholder:"请输入手机号",className:"h-12",maxLength:11,disabled:n})}),e.jsx(x,{})]})}),e.jsx(l,{control:o.control,name:"password",render:({field:t})=>e.jsxs(p,{children:[e.jsx(u,{className:"text-sm font-medium text-gray-700",children:"密码"}),e.jsx(h,{children:e.jsx(y,{...t,type:"password",placeholder:"请输入密码",className:"h-12"})}),e.jsx(x,{})]})}),e.jsx(l,{control:o.control,name:"agreedToTerms",render:({field:t})=>e.jsxs(p,{className:"flex flex-row items-start space-x-3 space-y-0",children:[e.jsx(h,{children:e.jsx(F,{checked:t.value,onCheckedChange:t.onChange})}),e.jsxs("div",{className:"space-y-1 leading-none",children:[e.jsxs(u,{className:"text-sm text-gray-600",children:["同意《",e.jsx(b,{href:"/terms",target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:text-blue-800 underline",children:"服务协议"}),"》和《",e.jsx(b,{href:"/privacy",target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:text-blue-800 underline",children:"隐私政策"}),"》"]}),e.jsx(x,{})]})]})})]}),e.jsx(j,{type:"submit",className:"w-full h-12 bg-blue-600 hover:bg-blue-700 text-white",disabled:n,children:n?"登录中...":"登录"})]})})}m.__docgenInfo={description:"",methods:[],displayName:"PhoneLoginForm",props:{onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: PhoneLoginData) => void",signature:{arguments:[{type:{name:"PhoneLoginData"},name:"data"}],return:{name:"void"}}},description:""},isLoading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const{expect:S,userEvent:c,within:L}=__STORYBOOK_MODULE_TEST__,Q={title:"Auth/Forms/PhoneLoginForm",component:m,parameters:{layout:"centered"},tags:["autodocs"]},a={render:()=>e.jsx("div",{className:"w-[400px] p-6",children:e.jsx(m,{onSubmit:s=>{console.log("Form submitted:",s)}})})},r={render:()=>e.jsx("div",{className:"w-[400px] p-6",children:e.jsx(m,{onSubmit:s=>{console.log("Form submitted:",s)},isLoading:!0})})},i={render:()=>e.jsx("div",{className:"w-[400px] p-6",children:e.jsx(m,{onSubmit:s=>{console.log("Form submitted:",s)}})}),play:async({canvasElement:s})=>{const n=L(s),o=n.getByPlaceholderText("请输入手机号");await c.type(o,"13812345678",{delay:50});const d=n.getByPlaceholderText("请输入密码");await c.type(d,"Password123",{delay:50});const t=n.getByRole("checkbox");await c.click(t);const g=n.getByRole("button",{name:/登录/i});await S(g).toBeEnabled(),await c.click(g)}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
...
should be tested in phone-login.test.tsx using RTL`,...i.parameters?.docs?.description}}};const W=["Default","Loading","HappyPath"];export{a as Default,i as HappyPath,r as Loading,W as __namedExportsOrder,Q as default};
