...
export interface ConfirmationBookingInfoPassengerProps {
  id: string;
  name: string;
...
export interface ConfirmationBookingInfoAncillaryProps {
  name: string;
  price: string;
}

export interface ConfirmationBookingInfoProps {
  passengers: ConfirmationBookingInfoPassengerProps[];
  contactPhone?: string | null;
  contactEmail?: string | null;
  ancillaryServices?: ConfirmationBookingInfoAncillaryProps[];
}
