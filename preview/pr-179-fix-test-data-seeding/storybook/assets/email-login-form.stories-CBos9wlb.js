import{j as e}from"./iframe-B3L8VP1V.js";import{u as f,a as v,F as w,b as d,c as p,d as u,e as x,f as h}from"./form-ir0V8rjY.js";import{L as b}from"./link-CJtEwOLf.js";import{B as j}from"./button-BLvKsEoH.js";import{C as E}from"./checkbox-B1tN4saG.js";import{I as y}from"./input-BODc4k2Y.js";import{e as F}from"./auth-CmJUVIQY.js";import"./preload-helper-PPVm8Dsz.js";import"./schemas-dlpNQSCA.js";import"./index-DhCLD_gq.js";import"./label-Rqfi2R25.js";import"./index-DziEteN5.js";import"./index-C-muzU9i.js";import"./utils-CBfrqCZ4.js";import"./index-CdJFUDDL.js";import"./index-t-iAWC5K.js";import"./index-CXHlMtPI.js";import"./index-BKa2Jzgu.js";import"./index-Du4gSAMX.js";import"./index-D398CZtf.js";import"./index-CDGzBvhH.js";import"./check-BrgraJLO.js";import"./createLucideIcon-C---1qUY.js";function m({onSubmit:t,isLoading:a=!1}){const o=f({resolver:v(F),defaultValues:{email:"",password:"",agreedToTerms:!1}}),c=s=>{t(s)};return e.jsx(w,{...o,children:e.jsxs("form",{onSubmit:o.handleSubmit(c),className:"space-y-6",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx(d,{control:o.control,name:"email",render:({field:s})=>e.jsxs(p,{children:[e.jsx(u,{className:"text-sm font-medium text-gray-700",children:"邮箱地址"}),e.jsx(x,{children:e.jsx(y,{...s,type:"email",placeholder:"请输入邮箱地址",className:"h-12"})}),e.jsx(h,{})]})}),e.jsx(d,{control:o.control,name:"password",render:({field:s})=>e.jsxs(p,{children:[e.jsx(u,{className:"text-sm font-medium text-gray-700",children:"密码"}),e.jsx(x,{children:e.jsx(y,{...s,type:"password",placeholder:"请输入密码",className:"h-12"})}),e.jsx(h,{})]})})]}),e.jsx(d,{control:o.control,name:"agreedToTerms",render:({field:s})=>e.jsxs(p,{className:"flex flex-row items-start space-x-3 space-y-0",children:[e.jsx(x,{children:e.jsx(E,{checked:s.value,onCheckedChange:s.onChange})}),e.jsxs("div",{className:"space-y-1 leading-none",children:[e.jsxs(u,{className:"text-sm text-gray-600",children:["我已阅读并同意",e.jsx(b,{href:"/terms",target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:underline ml-1",children:"服务协议"}),"和",e.jsx(b,{href:"/privacy",target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:underline ml-1",children:"隐私政策"})]}),e.jsx(h,{})]})]})}),e.jsx(j,{type:"submit",className:"w-full h-12 bg-blue-600 hover:bg-blue-700 text-white",disabled:a,children:a?"登录中...":"登录"})]})})}m.__docgenInfo={description:"",methods:[],displayName:"EmailLoginForm",props:{onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(data: EmailLoginData) => void",signature:{arguments:[{type:{name:"EmailLoginData"},name:"data"}],return:{name:"void"}}},description:""},isLoading:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const{expect:S,userEvent:l,within:N}=__STORYBOOK_MODULE_TEST__,W={title:"Auth/EmailLoginForm",component:m,parameters:{layout:"centered"},tags:["autodocs"]},r={render:()=>e.jsx("div",{className:"w-[400px] p-6",children:e.jsx(m,{onSubmit:t=>{console.log("Form submitted:",t)}})})},n={render:()=>e.jsx("div",{className:"w-[400px] p-6",children:e.jsx(m,{onSubmit:t=>{console.log("Form submitted:",t)},isLoading:!0})})},i={render:()=>e.jsx("div",{className:"w-[400px] p-6",children:e.jsx(m,{onSubmit:t=>{console.log("Form submitted:",t)}})}),play:async({canvasElement:t})=>{const a=N(t),o=a.getByPlaceholderText("请输入邮箱地址");await l.type(o,"test@example.com",{delay:50});const c=a.getByPlaceholderText("请输入密码");await l.type(c,"Password123",{delay:50});const s=a.getByRole("checkbox");await l.click(s);const g=a.getByRole("button",{name:/登录/i});await S(g).toBeEnabled(),await l.click(g)}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
