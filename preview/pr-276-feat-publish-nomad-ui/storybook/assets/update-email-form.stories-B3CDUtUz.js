import{r as I,j as o}from"./iframe-BY6WQ8rl.js";import{a as L}from"./zod-u2BPg-vl.js";import{u as q,F as N}from"./form-Cl4D1rHv.js";import{U as z}from"./update-phone-form-DjisV8wH.js";import"./otp-input-BLtKvdQh.js";import{u as D}from"./user-MfbVMCGJ.js";import{s as m}from"./storybook-logger-DgFpE3wU.js";import"./preload-helper-PPVm8Dsz.js";import"./schemas-BKf9BodT.js";import"./index-Cg4mt3GG.js";import"./createLucideIcon-DhaeV68V.js";import"./label-CxilLX0s.js";import"./index-B6rVzEen.js";import"./index-DRfufKDV.js";import"./button-Bkd1CeD9.js";import"./input-D0mA3Bj2.js";import"./check-DNbWv-jy.js";import"./x-CoTNxCXn.js";import"./card-C2MAT-zL.js";import"./platform-CXbBvqhr.js";import"./circle-x-CqC3SdqK.js";import"./circle-alert-BdeKJeaD.js";import"./circle-check-big-CNw7CXee.js";function p({currentEmail:e="",mode:t,onSubmit:i,onSendOtp:r,isLoading:a=!1,isVerifying:s=!1,countdown:y=0}){const d=q({resolver:L(D),defaultValues:{email:t==="verify"?e:"",otp:""}}),R=d.watch("email"),U=I.useRef(!1);I.useEffect(()=>{y>0&&(U.current=!0)},[y]);const C=v=>{i(v)},j=async()=>{const v=t==="verify"?e:d.getValues("email");t!=="verify"&&!await d.trigger("email")||r(v)};return o.jsx(N,{...d,children:o.jsx(z,{control:d.control,errors:d.formState.errors,onSubmit:d.handleSubmit(C),onSendOtp:j,currentEmail:e,emailValue:R,mode:t,isLoading:a,isVerifying:s,countdown:y,hasSent:U.current})})}p.__docgenInfo={description:`Container component for update email form
